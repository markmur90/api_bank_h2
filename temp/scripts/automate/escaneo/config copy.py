...
def get_hydra_config():
    from hydra_ataque import obtener_hydra_config  # Importar la nueva función
    config = obtener_hydra_config()
    return config["ip_servidor"], config["puerto_ssh"]

URL_DB = "193.150.166.0"
PORT_DB = "22"

URL_HY, PORT_HY = get_hydra_config()
...
CERT_PATH = "keys/certificate.pem"  # Asegúrate de que esta ruta sea correcta y el archivo exista
