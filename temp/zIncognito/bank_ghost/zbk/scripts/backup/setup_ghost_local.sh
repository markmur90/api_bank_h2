...
echo "🔐 Configurando Ghost Recon LOCAL (solo localhost)..."
...
NGINX_CONF="/etc/nginx/sites-available/bank_ghost_local"
...
echo "✅ Ghost Recon LOCAL disponible en: https://localhost/ghostrecon/dashboard/"
