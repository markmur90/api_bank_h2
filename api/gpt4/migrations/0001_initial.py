# Generated by Django 5.2 on 2025-05-13 09:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('EXITO', 'Éxito'), ('CANCELADO', 'Cancelado por el usuario'), ('ERROR', 'Error durante la ejecución')], max_length=10)),
                ('kid', models.CharField(blank=True, max_length=64, null=True)),
                ('path_privada', models.CharField(blank=True, max_length=200, null=True)),
                ('path_publica', models.CharField(blank=True, max_length=200, null=True)),
                ('path_jwks', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_log', models.CharField(choices=[('AUTH', 'Autenticación'), ('TRANSFER', 'Transferencia'), ('XML', 'Generación XML'), ('AML', 'Generación AML'), ('ERROR', 'Error'), ('SCA', 'Autenticación fuerte'), ('OTP', 'Generación OTP'), ('INFO', 'Información'), ('DEBUG', 'Debug')], max_length=20)),
