    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_log', models.CharField(choices=[('AUTH', 'Autenticación'), ('TRANSFER', 'Transferencia'), ('XML', 'Generación XML'), ('AML', 'Generación AML'), ('ERROR', 'Error'), ('SCA', 'Autenticación fuerte'), ('OTP', 'Generación OTP')], max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requested_execution_date', models.DateField(default=django.utils.timezone.now)),
