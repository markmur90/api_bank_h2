...
# === 22 ===
echo -e "\033[7;33m----------------------------------------------- GUNICORN ----------------------------------------------\033[0m" | tee -a $LOG_DEPLOY
ejecutar_si_activo "DO_GUNICORN" "Iniciar Gunicorn, honeypot y livereload" "bash $SCRIPTS_DIR/00_22_gunicorn.sh"
echo -e "\n\n"
pausa_y_limpiar

# === 23 ===
echo -e "\033[7;34m-------------------------------------------- DEPLOY COMPLETO ------------------------------------------\033[0m" | tee -a $LOG_DEPLOY
