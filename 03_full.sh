...
if [[ "$SYNC_REMOTE_DB" == true ]] || confirmar " Subir las bases de datos a la web "; then
...
if [[ "$HEROKU" == true ]] || confirmar " Subir el proyecto a la web "; then
...
# 12. Arranque de servicios
if [[ "$GUNICORN" == true ]] || confirmar "Iniciar Gunicorn, honeypot y livereload"; then
