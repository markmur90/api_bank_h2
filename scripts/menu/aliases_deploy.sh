...
alias d_Gsync='deploy_full -S -Gi'
...
alias cSIM='code ~/api_bank_h2/scripts/utils/simulator_bank'
...
alias zSync='d_local -r && vps_locsycl -1 && vps_sim_bank_start'

2menu() {
    typeset -A alias_groups
    alias_groups=(
        ["Code"]="cAPI cHER cNOT cFRE cSIM cSCR cMEN"
        ["Deploy"]="chmodtree zSync d_local d_njalla api_restart_local"
        ["Simulador"]="sim_bank_start sim_bank_env sim_bank_stop sim_bank_status sim_bank_restart testSIM"
