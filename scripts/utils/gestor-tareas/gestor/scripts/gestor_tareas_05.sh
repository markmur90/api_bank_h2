...
PROYECTO=$(zenity --entry --title="Seleccionar proyecto 05" \
...
TASK_FILE="$PROY_DIR/tareas_05.txt"
CONFIG_FILE="$PROY_DIR/config_05.txt"
TIME_LOG="$PROY_DIR/tiempos_05.log"
...
mostrar_gestor() {
    ...
    local options=$(zenity --forms --title="Gestor de Tareas 05 – $PROYECTO" \
        --text="$encabezado" \
