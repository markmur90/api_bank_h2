...
alias d_local_long='bash ./01_full.sh --env=local --do-sys --do-zip --do-ports --do-docker --do-mac --do-ufw --do-clean --do-json-local --do-sync-local --do-sync-remote-db --do-run_local --do-user --do-run-web --do-pem --do-heroku --do-varher --do-verif-transf --do-deploy-vps --do-local-ssl && d_ssl'
alias d_local='bash ./01_full.sh --env=local -P -D -M -x -C -Z -Q -I -L -S -V -p -u -H -B -v -E && d_ssl'

# 🔒 Local con modo dry-run (solo pruebas)
alias d_local_dry_long='bash ./01_full.sh --env=local --dry-run --do-sys --do-zip --do-clean --do-json-local --do-sync-local --do-user --do-run-web'
alias d_local_dry='bash ./01_full.sh --env=local --dry-run -P -C -Q -I -U -V'

# 🛰 Heroku completo
alias d_heroku_long='bash ./01_full.sh --env=heroku --do-sys --do-zip --do-clean --do-heroku --do-user --do-run-web --do-pem --do-ufw'
alias d_heroku='bash ./01_full.sh --env=heroku -P -C -u -U -V -p -x'

# 🛡 Producción Njalla con todo
alias d_njalla_long='bash ./01_full.sh --env=production --do-sys --do-zip --do-clean --do-varher --do-user --do-run-web --do-heroku --do-verif-transf --do-deploy-vps'
alias d_njalla='bash ./01_full.sh --env=production -P -C -H -U -V -u -B -v'

# 🔒 Producción (solo variables importantes)
alias d_production_vars_long='bash ./01_full.sh --env=production --do-sys --do-zip --do-clean --do-varher --do-user --do-run-web'
alias d_production_vars='bash ./01_full.sh --env=production -P -C -H -U -V'

# 🧪 Producción mínima (despliegue y ejecución web solamente)
alias d_prod_min_long='bash ./01_full.sh --env=production --do-deploy-vps --do-run-web'
alias d_prod_min='bash ./01_full.sh --env=production -v -V'
